...
func ExampleNewXMLFile() {
	...
	// 	<application android:allowTaskReparenting="false" android:allowBackup="false" android:backupAgent="" android:debuggable="false" android:description="" android:enabled="false" android:hasCode="false" android:hardwareAccelerated="false" android:icon="@0x7F020000" android:banner="" android:killAfterRestore="false" android:largeHeap="false" android:label="@0x7F040000" android:logo="" android:manageSpaceActivity="" android:name="" android:permission="" android:persistent="false" android:process="" android:restoreAnyVersion="false" android:requiredAccountType="" android:restrictedAccountType="" android:supportsRtl="false" android:taskAffinity="" android:testOnly="false" android:theme="" android:uiOptions="" android:vmSafeMode="false">
	// 		<activity android:theme="" android:banner="" android:icon="" android:name="FWMeasureActivity" android:label="" android:screenOrientation="0">
	// 			<intent-filter>
	// 				<action android:name="android.intent.action.MAIN"></action>
	// 				<category android:name="android.intent.category.LAUNCHER"></category>
	// 			</intent-filter>
	// 		</activity>
	// 		<activity android:theme="" android:banner="" android:icon="" android:name="MapActivity" android:label="" android:screenOrientation="0"></activity>
	// 		<activity android:theme="" android:banner="" android:icon="" android:name="SettingActivity" android:label="" android:screenOrientation=""></activity>
	// 		<activity android:theme="" android:banner="" android:icon="" android:name="PlaceSettingActivity" android:label="" android:screenOrientation=""></activity>
	// 	</application>
